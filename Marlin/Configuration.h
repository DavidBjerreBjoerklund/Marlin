...
#define MAX_BED_POWER 100 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 141.85
  #define  DEFAULT_bedKi 26.07
  #define  DEFAULT_bedKd 192.91
#endif // PIDTEMPBED
...
#define X_STEPS_PER_MM ((X_MOTOR_STEPS * X_DRIVER)/(X_BELT_PITCH * X_PULLY_TEETH))+1

#define Y_MOTOR_STEPS 200
#define Y_DRIVER       128  
#define Y_BELT_PITCH  2
#define Y_PULLY_TEETH 20
#define Y_STEPS_PER_MM ((Y_MOTOR_STEPS * Y_DRIVER)/(Y_BELT_PITCH * Y_PULLY_TEETH))
...
#define GEAR_RATIO 3
#define HOBB  7.3
#define E_STEPS_PER_MM E_MOTOR_STEPS * E_DRIVER * GEAR_RATIO / (HOBB * 3.142)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 40, 50 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 1500, 100, 6000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.120   // Z offset: -below +above  [the nozzle]
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + (-1*X_PROBE_OFFSET_FROM_EXTRUDER)
 ...
 */
  ...
  #define PROBE_PT_1_Y 285
  #define PROBE_PT_2_X 15
  #define PROBE_PT_2_Y 15
  #define PROBE_PT_3_X 285
